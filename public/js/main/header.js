...
$(document).ready(function() {
  ...
  //var tab = ["Products","Clients","Careers","Book a Demo"];
    var tabs =[ {name: "Products", class: "products", slug: "javascript:void(0)", click:""},
                ...
                // {name: "COVID 19 ", class: "careers", slug: "https://greenwheels.com/covid-19-section", click:""},
...
<div class="small-block-grid-2 show-for-small-only">
  ...
  <li><a class="font_family_a font_color_b font_size_16px font-100" href="https://greenwheels.com/restaurant-software/cloud-kitchen-software">Cloud Kitchen </a></li>
              ...
              <a href="https://greenwheels.com/covid-19-section"><h6 class="font_family_a font_size_24px font-600">COVID 19</h6></a>
              </div>
              <br>
                </ul>
...
<div class="row" style="margin-left: -10px!important">
  ...
  <ul class=" small-block-grid-1" >
   <li><a class="font_family_a font_color_b font_size_16px font-100" href="https://greenwheels.com/about-us">About Us</a></li>
           ...
           <li><a class="font_family_a font_color_b font_size_16px font-100" href="https://greenwheels.com/restaurant-analytics-solution">Pulse</a></li>
<li><a class="font_family_a font_color_b font_size_16px font-100" href="https://greenwheels.com/restaurant-guest-post-contribution">Contribute An Article</a></li>
           </div>
 </ul>
  <div class="columns small-6"> 
<ul class="small-block-grid-1">
